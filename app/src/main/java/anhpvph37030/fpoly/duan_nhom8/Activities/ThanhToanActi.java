...
public class ThanhToanActi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnthanhtoan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                hienThiThongBao("Thông báo thanh toán", "Thanh toán thành công đơn hàng của bạn đang chờ xác nhận");
    ...
    private void hienThiThongBao(String title, String body) {
        ...
        builder
                .setSmallIcon(R.drawable.logodong) // Thay thế bằng icon thông báo của bạn
